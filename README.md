...
Files in the repository:
  - dl_milestone1.ipynb:
      In this file, we explore the metadata downloaded from the Kaggle website. We take a look at some of the images of the spectograms in the dataset.
      We make decisions about what attributes to keep, and we split the matedata into training (70%), validation (20%) and test (10%) datasets.
